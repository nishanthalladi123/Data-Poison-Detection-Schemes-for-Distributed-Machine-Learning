...
def graph():
    ...
    try:
        ...
        if 'svm_acc' in globals() and 'basic_acc' in globals() and 'semi_acc' in globals():
            ...
            messagebox.showwarning("Warning", "Please run Basic-DML and Semi-DML before generating the graph")
